 ...
 *
 * Es un client component con nodo DOM propio a propósito: un componente que
 * devuelve `null` no recibe ancla de hidratación y su efecto nunca llega a
 * ejecutarse, que fue exactamente por lo que la restauración no funcionaba.
 *
 ...
 */
export function MovementList({ restorationKey, className, children }: MovementListProps) {
  ...
  return (
    <div className={className} onClickCapture={handleClickCapture} ref={containerRef}>
      {children}
    </div>
  );
}
