...
const paths: Record<NavIconName, React.ReactNode> = {
  ...
  // Una etiqueta: el nombre que se le cuelga a un gasto para poder agruparlo.
  categories: <><path d="M4 5.5A1.5 1.5 0 0 1 5.5 4h5l9 9-6.5 6.5-9-9z" /><circle cx="8.5" cy="8.5" r="1.1" /></>,
