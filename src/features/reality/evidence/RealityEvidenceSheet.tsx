...
import styles from "./RealityEvidenceSheet.module.css";

export interface RealityEvidenceSheetProps {
  model: RealityEvidence;
  open: boolean;
  onOpenChange: (open: boolean) => void;
  returnFocusRef?: RefObject<HTMLElement | null>;
}

export function RealityEvidenceSheet({
  model,
  open,
  onOpenChange,
  returnFocusRef,
}: RealityEvidenceSheetProps) {
  return (
    <BottomSheet
