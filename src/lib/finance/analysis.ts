...
// La composición de /mi-realidad vive en `reality.ts` y el cierre mensual en
// `close.ts`: los dos reutilizan `patrimonialMovements` y `signedPatrimonyEffect`
// de acá, así que las reglas del ledger se escriben una sola vez.
